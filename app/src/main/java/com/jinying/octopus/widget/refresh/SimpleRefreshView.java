...
public class SimpleRefreshView extends LinearLayout implements IHeaderWrapper {
    ...
    private void initView() {
        ...
        mIvRefresh = view.findViewById(R.id.iv_refresh_image);
        mTvRefresh = view.findViewById(R.id.tv_refresh_text);
...
//        mTvRefresh.setText("下拉刷新");
    	mIvRefresh.setTranslationY(0);
    }

    @Override
    public void pullDownReleasable() {
//        mTvRefresh.setText("松手可刷新");
    	mIvRefresh.setTranslationY(60);
    }

    @Override
    public void pullDownRelease() {
    	ObjectAnimator.ofFloat(mIvRefresh, "translationY", 40,25,15).setDuration(400).start();
