...
public class PageWidget extends View{
	...
	private int mWidth = (int) App.width;
	private int mHeight = (int) App.height;
	...
	public boolean doTouchEvent(float x,float y) {
		// TODO Auto-generated method stub
			...
			if (canDragOver()) {
				startAnimation(0);
				//TODO 以后可以添加翻页成功 修改ReadPersenter pageNum
			} 
//			else {
//				mTouch.x = mCornerX - 0.09f;
//				mTouch.y = mCornerY - 0.09f;
			//TODO 以后可以添加翻页不成功 不修改ReadPersenter pageNum
//			}
...
//			}
	...
	protected void onDraw(Canvas canvas) {
		if(isFirst){
			canvas.drawColor(0XFFFFFF);//翻页背面颜色
			isFirst = false;
		}else{
			canvas.drawColor(0XFFAAAAAA);//翻页背面颜色
		}
		calcPoints();
